...
import { Navigation, Footer, Photo, Arrow } from "./Experience";
...
export function Plans() {return <><PlanCards /><p className="termsNote">Criação incluída · Domínio sujeito à disponibilidade. Escopo e condições definidos na proposta.</p></>;}
...
const headings = {
  ...
  sobre: ["POR TRÁS DE CADA DETALHE", "Bons negócios merecem ser bem apresentados.", "A Marquesano aproxima pequenos negócios de uma presença digital cuidada, clara e profissional."],
