...
export const initialPlans = [
  ...
  { id: 'intermediario', name: 'Professional', description: 'Mais espaço para apresentar o valor do seu negócio.', monthly_price_cents: null, cycles: 12, active: false },
  { id: 'professional', name: 'Business', description: 'Uma experiência conectada à sua operação.', monthly_price_cents: null, cycles: 12, active: false },
];
